        ...
        <!----------------------------------------------------------------------------------------------------------------------------N A V B A R ----------------------->
                <div class="container-fluid">
                    <div class="header pb-6 d-flex align-items-center">
                        <img class="header pb-6 d-flex align-items-center" src="../../img/icon/head.png" style="background-image: url('../../img/icon/head.png'); width: 100%; background-size: cover; background-position: center top;">
