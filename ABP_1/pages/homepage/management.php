...
<div class="photo">
            ...
            <div class="card-wrapper">
                <div class="card">
                    <div class="card-image">
                        <img class="photoimg" src="assets/images/v1.jpeg" alt="profile one">
                    </div>
        ...
        <div class="containerphoto">
            <div class="card-wrapper">
                <div class="card">
                    <div class="card-image">
                        <img class="photoimg" src="assets/images/prerak.jpg" alt="profile one">
                    </div>
        ...
        <div class="containerphoto">
            <div class="card-wrapper">
                <div class="card">
                    <div class="card-image">
                        <img class="photoimg" style="top:-1px;left: -89px;" src="assets/images/s1.jpeg" alt="profile one">
                    </div>
    ...
    <div class="containerphoto">
        <div class="card-wrapper">
            <div class="card">
                <div class="card-image">
                    <img class="photoimg" src="assets/images/rushi.jpeg" alt="profile one">
                </div>
